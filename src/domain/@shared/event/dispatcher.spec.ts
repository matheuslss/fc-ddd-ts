...
import SendEmailWhenProductCreatedHandler from "../../product/event/handler/send_email_when_product_created";
import ProductCreatedEvent from "../../product/event/product_created";
